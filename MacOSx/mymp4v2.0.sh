#!/bin/bash
# MyMp3 Youtube Download to mp3 script by dejavudf
...
#download yt-dlp
clear
echo "Baixando yt-dlp. Por favor, aguarde..."
if curl -L https://github.com/yt-dlp/yt-dlp/releases/latest/download/yt-dlp_macos -o ./yt-dlp
then
	chmod u+x ./yt-dlp

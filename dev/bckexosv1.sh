#!/bin/bash
cd /home/netsight/scripts/bckcores
...
do
        ../random -p $VAR_RANDOM ssh -i $VAR_RSA -o $VAR_KEY -o $VAR_STRICT -o $VAR_ALGO $VAR_USER@$VAR_IP -o $VAR_ACE -o RemoteCommand="dis cli pag perm"
        if ../random -p $VAR_RANDOM ssh -i $VAR_RSA -o $VAR_KEY -o $VAR_STRICT -o $VAR_ALGO $VAR_USER@$VAR_IP -o $VAR_ACE -o RemoteCommand="$VAR_CMD" \
